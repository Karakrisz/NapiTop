              ...
              <li v-for="link in links" :key="link.path" class="mobile-menu-item">
                ...
                >
                  <span class="mobile-menu-icon">
                    <svg v-if="link.icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      <!-- Főoldal ikon -->
                      ...
                      <template v-else-if="link.icon === 'handshake'">
                        ...
                        <path d="M5 19.5H2V13.5C2 13.5 7 11.5 9 12.5C11 13.5 13 15.5 15.5 15.5C18 15.5 20 13 22 13.5"></path>
                        <path d="M2 6.5C2 6.5 7 4.5 9 5.5C11 6.5 13 8.5 15.5 8.5C18 8.5 22 6.5 22 6.5"></path>
                      </template>
