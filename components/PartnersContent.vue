...
const imageUrls = [
  '/img/partners/partner.webp',
  '/img/partners/partner2.webp',
  '/img/partners/partner3.webp',
  '/img/partners/partner4.webp',
]

const partners = [
  { name: 'Ételbár Makó', image: imageUrls[0] },
  { name: 'Virág Varázs Makó', image: imageUrls[1] },
  { name: 'm', image: imageUrls[2] },
  { name: 'Buliszerviz', image: imageUrls[3] },
]
